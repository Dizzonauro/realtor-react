...
export default function EditListing() {
  ...
  const styledInputLat = 'text-lg font-semibold';
  ...
  async function onSubmit(e) {
    ...
    if (+discountedPrice >= +regularPrice) {
      setLoading(false);
      toast.error('The discounted price need to be less than regular price ');
      return;
    }
    if (images.length > 6) {
      setLoading(false);
      ...
      <form onSubmit={onSubmit}>
        ...
        {!geolocationEnable && (
          <div className="flex space-x-6 justify-start mb-6">
            <div className="">
              <p className={styledInputLat}>Latitude</p>
              <input
                type="number"
                id="latitude"
                value={latitude}
            ...
            <div className="">
              <p className={styledInputLat}>Longitude</p>
              <input
                type="number"
                id="longitude"
                value={longitude}
