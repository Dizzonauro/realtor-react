...
export default function Listing() {
  ...
  return (
    <main>
      ...
      {shareLinkCopied && (
        <p className="fixed top-[20%] right-[3%] font-semibold z-10 border-2 border-gray-400 rounded-md bg-white p-2">
          Link Copied
        </p>
      )}
      <div className="flex flex-col md:flex-row max-w-6xl lg:mx-auto m-4 p-4 rounded-lg shadow-lg bg-white lg:space-x-4">
        ...
        <div className="w-full h-[200px] md:h-[400px] z-10 overflow-x-hidden md:ml-2">
          <MapContainer
